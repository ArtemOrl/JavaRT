...
//        System.out.println(list.get(0).size());
        List<List> list1 = findObjects(povorotNa90GradPochas(arr));
    ...
    public static List findObjects(String[][] arr){
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            System.out.println(ifO(strings));
            ...
            if (ifO(strings)==true && howManyO(strings)==1){
//                System.out.println(list1.size() + " list1.size");
                list.add(list1);
//                System.out.println(list.size() + " list.size");
//                System.out.println(list.get(i).size() + " list.get(iii).size()");
//                System.out.println(list1.size() + " list1.size");
...
//        System.out.println(list.get(0).size() + " list.get(1).size() end");
//        System.out.println(list.size() + " list.size");
        return list;
    }
